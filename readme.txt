...
Contributors: Benoti
Tags: loading, bar, pace, material, design, divi, elementor, animated progress bar, circled progress bar, animation, loading-bar, styling, automatic, progress-bar, loader, center, circle, radar, corner, indicator
...
== Installation ==
1. Upload "Brozzme Material Loading" to the "/wp-content/plugins/" directory.
2. Activate the plugin through the "Plugins" menu in WordPress.
3. Click Settings to change the predefined animation, color and height.


== Frequently Asked Questions ==
= Loading bar doesn\'t appears =
Some theme doesn\'t use the body class admin-bar, when you are not log in the bar appears.

= The loading bar still not appears =
Check if the plugin is enable in the Material Loading settings panel, check for the color. You maybe also need to check for any z-index properties on header.

= How can I stop loading for some elements =
It is not possible with this version.


== Screenshots ==
1. Settings panel. screenshot-1.png.
2. Corner indicator. screenshot-2.png.
3. Homepage corner indicator. screenshot-3.png.
4. Minimal progress bar. screenshot-4.png.
5. Circle center. screenshot-5.png.
